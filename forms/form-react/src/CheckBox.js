...
const App = () => {
  ...
  const [value, setValue] = useState({normal:"",textoarea:"",selectCombobox:"opcion1", check:false });
  
  //se aplico un destructuring para obtener el valor del target
  //es decir obtener el valor del input pero tambien se puede con e y llama e.target.value 
